...
ALL_RELATIVE_VECTORS = (
    ...
    MOTION_DATA.JERK_VEC3, MOTION_DATA.JERK_ERR_VEC3, MOTION_DATA.CRACKLE_VEC3, MOTION_DATA.ROTATION_VEC3,
...
SLIGHT_EXPLANATION_KEYS = (
    MOTION_DATA.LAST_CURVATURE,
    MOTION_DATA.DISP_MAG_DIFF,
    MOTION_DATA.DISP_MAG_DIFF_TIMESCALED,
    MOTION_DATA.DISP_MAG_RATIO,
    MOTION_DATA.UNIT_ROT_AX_DIFF,
    MOTION_DATA.UNIT_ROT_AX_DIFF_TIMESCALED,
    MOTION_DATA.SPEED_ACC_RATIO,
    MOTION_DATA.SPEED_JERK_RATIO,
    MOTION_DATA.ACC_JERK_RATIO,
    MOTION_DATA.SPEED_ORTHO_ACC_RATIO,
    MOTION_DATA.CIRC_ACC_CIRC_SPEED_RATIO,
    MOTION_DATA.CIRC_ANG_ACC_CIRC_ANG_SPEED_RATIO,
    MOTION_DATA.CIRC_ANG_RATIO,
    MOTION_DATA.INV_DISP_MAG_RATIO,
    MOTION_DATA.INV_CIRC_ANG_RATIO,
    MOTION_DATA.VEL_DEG2_MAG_DIFF,
    MOTION_DATA.VEL_DEG2_MAG_DIFF_TIMESCALED,
)

LONG_EXPLANATION_KEYS = (
    # MOTION_DATA.CIRC_VEL_DEG1_ERR_VEC3,
    # MOTION_DATA.CIRC_VEL_DEG2_ERR_VEC3,
    # MOTION_DATA.CIRC_ACC_ERR_VEC3,
    MOTION_DATA.AX3_SQ_DIFF,
    MOTION_DATA.CIRC_VEC6_DIFF,
    MOTION_DATA.TIME_SINCE_STATIONARY,
    MOTION_DATA.TIME_SINCE_DIR_CHANGE,
    MOTION_DATA.DIST_SINCE_DIR_CHANGE,
    MOTION_DATA.TIME_CIRC_MOTION,
    MOTION_DATA.ANG_SUM_CIRC_MOTION,
    MOTION_DATA.DIST_SUM_CIRC_MOTION,
    MOTION_DATA.FRAME_NUM,
    MOTION_DATA.TIMESTAMP,
    MOTION_DATA.PREV_FA_ANG_ACC,
    MOTION_DATA.NEXT_FA_ANG_ACC,
    MOTION_DATA.VEL_BCS_RATIOS,
    MOTION_DATA.BOUNCE_ANGLE_2_SUM,
    MOTION_DATA.INV_VEL_BCS_RATIOS,
    MOTION_DATA.GT0,
    MOTION_DATA.GT1,
    MOTION_DATA.GT2,
    MOTION_DATA.GT3,
